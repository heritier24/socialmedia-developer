<template>
  ...
  <div class="wrapper">
          ...
          <ul id="iq-sidebar-toggle" class="iq-menu">
            ...
            <li class="">
              <a
                ...
                class="collapsed"
                aria-expanded="false"
                ><i class="ri-focus-2-line"></i><span>Facebook</span
                ><i class="ri-arrow-right-s-line iq-arrow-right"></i
              ></a>
              <ul
                id="ui-elements"
                  ...
                  >
                    ...
                    <li class="">
                      <a href="dashboard/form-wizard-vertical.html"
                        ><i class="ri-anticlockwise-line"></i>Vertical Wizard</a
                      >
                    </li>
                  </ul>
                </li>
            ...
            <li class="">
              <a
                ...
                data-bs-toggle="collapse"
                aria-expanded="false"
                ><i class="ri-pages-line"></i><span>Linkedln</span
                ><i class="ri-arrow-right-s-line iq-arrow-right"></i
              ></a>
              <ul
                id="pages"
                  ...
                  >
                    ...
                    <li class="">
                      <a href="dashboard/pages-recoverpw.html"
                        ><i class="ri-record-mail-line"></i>Recover Password</a
                      >
                    </li>
                    <li class="">
    ...
    <div id="content-page" class="content-page">
      <div class="container">
        <NewsFeed v-if="newsFeediv" />
        <Profile v-if="profileDiv" />
      </div>
    </div>
  </div>
  <!-- Wrapper End-->
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-6 d-flex justify-content-end">
          Copyright 2025 <a href="#">Tamba Group </a> All Rights Reserved.
        </div>
      </div>
    </div>
  </footer>
